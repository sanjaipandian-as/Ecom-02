...
export const createPaymentOrder = async (req, res) => {
  try {
    ...
    const shippingFee = 0; // ⚠️ TEMP: Set to 0 for testing. Restore to: totalAmount > 999 ? 0 : 99
...
export const verifyPayment = async (req, res) => {
  try {
    ...
    const verifyShippingFee = 0; // ⚠️ TEMP: Set to 0 for testing. Restore to: serverCalculatedTotal > 999 ? 0 : 99
