...
const AboutUs = () => {
    ...
    const milestones = [
        { year: '1998', event: 'Anti Turnish Jewellery founded in Sivakasi, Tamil Nadu' },
        ...
        <div className="min-h-screen bg-white">
            ...
            <header className="bg-white border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <h1 className="text-4xl font-bold text-gray-900">About Anti Turnish Jewellery</h1>
            ...
            <section className="py-16 bg-primary text-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-primary-foreground/80 max-w-3xl mx-auto leading-relaxed">
                        For over 25 years, Anti Turnish Jewellery has been bringing joy and light to millions of celebrations
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                            <p>
                                Anti Turnish Jewellery was founded in 1998 in Sivakasi, Tamil Nadu, the fireworks capital of India.
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Why Choose Anti Turnish Jewellery?</h2>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-lg text-gray-700 leading-relaxed mb-8">
                            At Anti Turnish Jewellery, we're committed to making your celebrations memorable, safe, and
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="max-w-3xl mx-auto bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
                        <h3 className="text-xl font-bold text-gray-900 mb-4">Anti Turnish Jewellery Headquarters</h3>
            ...
            <section className="py-16 bg-primary text-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
                        Experience the Anti Turnish Jewellery difference. Safe, certified, and joyful celebrations await you.
                    </p>
