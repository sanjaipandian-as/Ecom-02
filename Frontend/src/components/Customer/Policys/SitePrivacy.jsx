                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8 md:p-10 space-y-6">
                    ...
                    <div className="space-y-3 text-sm text-gray-700">
                        <p className="leading-relaxed">
                            We value the trust you place in us and recognize the importance of secure transactions and information privacy. This Privacy Policy describes how Anti Turnish Jewellery Private Limited and its affiliates, group companies and related parties (collectively "Anti Turnish Jewellery, we, our, us") collect, use, share or otherwise process your personal data through Anti Turnish Jewellery website www.apkcrackers.com, its mobile application, and m-site (hereinafter referred to as the "Platform").
                        </p>
                        <p className="leading-relaxed">
                    ...
                    <section className="space-y-3">
                        ...
                        <div className="text-sm text-gray-700 space-y-2">
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg space-y-1">
                                ...
                                <p>Anti Turnish Jewellery Private Limited</p>
                    ...
                    <div className="text-center text-xs text-gray-500 pt-6 border-t border-gray-200">
                        ...
                        <p className="mt-2">© 2024 Anti Turnish Jewellery Private Limited. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
