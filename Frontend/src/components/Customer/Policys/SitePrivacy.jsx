...
const PrivacyPolicy = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-primary/5 via-white to-secondary/5 font-outfit">
            {/* Header */}
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8 md:p-10 space-y-6">
                    ...
                    <section className="space-y-3">
                        ...
                        <p className="text-sm text-gray-700 leading-relaxed">
                            We use third-party advertising companies to serve ads when you visit our Platform. These companies may use information (not including your name, address, email address, or telephone number) about your visits to this and other websites in order to provide personalized advertisements about goods and services of interest to you. You have an option to opt out from tracking of personalized advertising using the "Opt out of Ads Personalization" settings using your device's settings application. Plenora will have no access to your GAID once you select this feature.
                        </p>
                    </section>

                    {/* Children Information & COPPA Compliance */}
                    <section className="space-y-3">
                        <h2 className="text-base font-bold text-gray-900">Children Information</h2>
                        <p className="text-sm text-gray-700 leading-relaxed">
                            Use of our Platform is available only to persons who can form a legally binding contract under the Indian Contract Act, 1872. <strong>We do not knowingly solicit, collect, or process personal data from children under the age of 13 years.</strong> If you are under the age of 13, please do not attempt to register on our Platform or send any personal information about yourself to us. If we learn or are notified that we have collected personal data from a child under 13, we will delete that information from our servers immediately to comply with COPPA and other child privacy protection regulations. If you are a minor between the ages of 13 and 18, you represent that you are using this Platform under the supervision and consent of a parent or legal guardian.
                        </p>
                    </section>
